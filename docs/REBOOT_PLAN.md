...
- [x] M9.3 Performance pass: 300 units + 60 buildings at 60fps render / stable 15 t/s sim on a MacBook Air (measure with a headless perf test in node; budget: tick < 8ms at 300 entities).
...
- [x] M10.3 GitHub Pages workflow so the owner gets a playable URL.
